...
import (
	...
	nodeaffinityhelper "k8s.io/component-helpers/scheduling/corev1/nodeaffinity"
	"k8s.io/klog/v2"
...
func checkNodeFitness(pod *corev1.Pod, node *corev1.Node) (bool, error) {
	...
	fitsNodeAffinity, _ := nodeaffinityhelper.GetRequiredNodeAffinity(pod).Match(node)
	if !fitsNodeAffinity {
