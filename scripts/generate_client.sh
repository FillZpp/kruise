...
(cd "${TMP_DIR}"/src/github.com/openkruise/kruise; \
    ...
    github.com/openkruise/kruise/pkg/client github.com/openkruise/kruise/apis "apps:v1alpha1 apps:v1beta1 ctrlmesh:v1alpha1 public:v1alpha1" -h ./hack/boilerplate.go.txt)
